...
kineval.robotDraw = function drawRobot() {
    ...
    if (kineval.params.ik_orientation_included)
        endeffector_mat = matrix_2Darray_to_threejs(matrix_multiply(robot.joints[robot.endeffector.frame].xform,generate_translation_matrix1(robot.endeffector.position[0],robot.endeffector.position[1],robot.endeffector.position[2])));
    else {
        endeffector_world = matrix_multiply(robot.joints[robot.endeffector.frame].xform,robot.endeffector.position);
        endeffector_mat = matrix_2Darray_to_threejs(generate_translation_matrix1(endeffector_world[0],endeffector_world[1],endeffector_world[2]));
    }
    ...
    if (kineval.params.ik_orientation_included)
        var target_mat = matrix_2Darray_to_threejs(
            matrix_multiply(
                generate_translation_matrix1(kineval.params.ik_target.position[0][0],kineval.params.ik_target.position[1][0],kineval.params.ik_target.position[2][0]),
                matrix_multiply(
        ...
        var target_mat = matrix_2Darray_to_threejs(generate_translation_matrix1(kineval.params.ik_target.position[0][0],kineval.params.ik_target.position[1][0],kineval.params.ik_target.position[2][0]));
...
kineval.initParameters = function initParameters() {
    ...
    if (robot.name === 'fetch') {  // fetch easter egg
        ...
        kineval.setpoints = 
            ...
            {"torso_lift_joint":0.4,"shoulder_pan_joint":0.0004677854383942246,"shoulder_lift_joint":-1.221,"upperarm_roll_joint":-0.00037940857494373875,"elbow_flex_joint":0.00024155542149740568,"forearm_roll_joint":0.00001232914385335755,"wrist_flex_joint":0.00040145426866142973,"wrist_roll_joint":4.319780384106989e-8,"gripper_axis":4.319780384107232e-8,"head_pan_joint":1.904819311566239e-8,"head_tilt_joint":1.759228026605762e-8,"torso_fixed_joint":4.319780384108353e-8},
            {"torso_lift_joint":0.4,"shoulder_pan_joint":-1.61,"shoulder_lift_joint":0,"upperarm_roll_joint":0,"elbow_flex_joint":0.91,"forearm_roll_joint":0.77,"wrist_flex_joint":0,"wrist_roll_joint":0,"gripper_axis":0,"head_pan_joint":0,"head_tilt_joint":0,"torso_fixed_joint":0},
            {"torso_lift_joint":0.4,"shoulder_pan_joint":-1.61,"shoulder_lift_joint":0,"upperarm_roll_joint":0,"elbow_flex_joint":0.91,"forearm_roll_joint":0.77,"wrist_flex_joint":0.99,"wrist_roll_joint":0,"gripper_axis":0,"head_pan_joint":0,"head_tilt_joint":0,"torso_fixed_joint":0},
            {"torso_lift_joint":0.4,"shoulder_pan_joint":1.61,"shoulder_lift_joint":0,"upperarm_roll_joint":0,"elbow_flex_joint":-0.91,"forearm_roll_joint":0.77,"wrist_flex_joint":0,"wrist_roll_joint":0,"gripper_axis":0,"head_pan_joint":0,"head_tilt_joint":0,"torso_fixed_joint":0},
            {"torso_lift_joint":0.4,"shoulder_pan_joint":1.61,"shoulder_lift_joint":0,"upperarm_roll_joint":0,"elbow_flex_joint":-0.91,"forearm_roll_joint":0.77,"wrist_flex_joint":-0.99,"wrist_roll_joint":0,"gripper_axis":0,"head_pan_joint":0,"head_tilt_joint":0,"torso_fixed_joint":0},
            {"torso_lift_joint":0,"shoulder_pan_joint":0,"shoulder_lift_joint":0,"upperarm_roll_joint":0,"elbow_flex_joint":0,"forearm_roll_joint":0,"wrist_flex_joint":0,"wrist_roll_joint":0,"gripper_axis":0,"head_pan_joint":0,"head_tilt_joint":0,"torso_fixed_joint":0},
            {"torso_lift_joint":0,"shoulder_pan_joint":0,"shoulder_lift_joint":0,"upperarm_roll_joint":0,"elbow_flex_joint":0,"forearm_roll_joint":0,"wrist_flex_joint":0,"wrist_roll_joint":0,"gripper_axis":0,"head_pan_joint":0,"head_tilt_joint":0,"torso_fixed_joint":0},
